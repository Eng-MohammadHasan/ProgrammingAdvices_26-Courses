...
bool WithdrawFromClientBalanceByAccountNumber(const string& AccountNumber, double WithdrawAmount, vector<sClient>& vClients)
{
	char Answer = 'n';
...
void ShowTransactionsMenu()
{
	...
	enTransactionsMenuOptions TransactionMenuOption;
	TransactionMenuOption = ReadTransactionsMenuOption();

	PerformTransactionsMenuOption(TransactionMenuOption);
}
