...
bool IsDate1BeforeDate2(const sDate& Date1 ,const sDate& Date2)
{
	...
	if (Date1.Year == Date2.Year)
	{
		unsigned short DaysForDate1 = NumberOfDaysFromTheBeginningOfTheYear(Date1.Day, Date1.Month, Date1.Year);
		unsigned short DaysForDate2 = NumberOfDaysFromTheBeginningOfTheYear(Date2.Day, Date2.Month, Date2.Year);

		if(DaysForDate1 < DaysForDate2)
			return true;
	}
